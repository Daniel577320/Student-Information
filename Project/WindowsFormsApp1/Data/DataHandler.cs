...
namespace WindowsFormsApp1.Data
{
    ...
    {
        public void writeToFile(List<string> LoginList)
        {
            try
            {
                string baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
                string filePath = Path.Combine(baseDirectory, "Login.txt");
        ...
        public List<String> readFromFile(List<string> LoginList)
        {
            string baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
            string filePath = Path.Combine(baseDirectory, "Login.txt");
